...
const infoData = [
    {
        icon: <User2 size={20} />,
        text: "Iqbal Mauludi Pratama",
    },
    {
        icon: <GraduationCap size={20} />,
        text: "Bachelor of Infomatics Engineering",
    },
    {
    ...
    },
    {
        ...
        text: "+62 858 6656 5760",
    },
    {
        icon: <HomeIcon size={20} />,
        text: "Brebes, Central Java, Indonesia",
    },
    {
        icon: <MailIcon size={20} />,
        text: "iqbalmauludipratama019@gmail.com",
    },
];
...
const qualificationData = [
    {
        ...
        data: [
            {
                university: "STMIK Muhammadiyah Paguyangan Brebes",
                qualification: "Bachelor of Informatics Engineering",
                years: "2019 - 2023",
            },
            {
                university: "SMK Muhammadiyah Bumiayu",
                qualification: "Department of Computer and Network Engineering",
                years: "2016 - 2019",
            },
        ],
    },
            ...
            <div className="container mx-auto">
                ...
                <div className="flex flex-col xl:flex-row">
                    ...
                    <div className="hidden xl:flex flex-1 relative">
                        <DevImg containerStyles="bg-about_shape_light dark:bg-about_shape_dark w-[505px] h-[505px] bg-no-repeat relative" imgSrc="/about/iqbal.png" />
                    </div>
                    {/* tabs */}
                            ...
                            <div className="text-lg mt-12 xl:mt-8">
                                ...
                                <TabsContent value="personal">
                                    <div className="text-center xl:text-left">
                                        ...
                                        <p className="subtitle max-w-xl mx-auto xl:mx-0">I specialize is crafting instuitive websites with cuttig-edge technilogy, delivering dynamic and engaging</p>
                                        {/* icons */}
                                ...
                                <TabsContent value="qualifications">
                                    <div>
                                        ...
                                        <div className="grid md:grid-cols-2 gap-y8">
                                            {/* experience */}
                                            <div className="flex flex-col gap-y-6">
                                                ...
                                                <div className="flex flex-col gap-y-8">
                                                    {getData(qualificationData, "experience").data.map((item, index) => {
                                                        ...
                                                        return (
                                                            <div className="flex gap-x-8 group bg-lightblue" key={index}>
