                ...
                <div className="container mx-auto">
                    <div className="flex justify-between gap-x-8">
                        ...
                        <div className="flex max-w-[600px] flex-col justify-center mx-auto xl:mx-0 text-center xl:text-left">
                            ...
                            <h1 className="h1 mb-4">Hello, I'm Iqbal Mauludi Pratama</h1>
                        ...
                        <div className="hidden xl:flex relative">
                            {/* badge 1 */}
                            <Badge containerStyles="h-[60px] w-[180px] absolute top-[26%] -left-[4rem]" icon={<RiBriefcase4Fill className="text-foreground dark:text-background" />} endCountNum={4} badgeText="Year of Experience" />
                            {/* badge 2 */}
                            <Badge containerStyles="h-[60px] w-[165px] absolute top-[38%] -right-9" icon={<RiTodoFill className="text-foreground dark:text-background" />} endCountNum={7} badgeText="Finished Project" />
                            {/* badge 3 */}
